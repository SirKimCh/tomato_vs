...
def run_experiment(dataset_dir, exp_name, seed, trial, pretrained_flag, output_dir, training_curves_data):
...
def run_major_experiment(pretrained_flag, output_dir):
    ...
    pretrained_str = "Pretrained=True" if pretrained_flag else "Pretrained=False"
    print(f"\n{'='*60}")
    print(f"RUNNING: {pretrained_str}, No Freezing")
        ...
        for exp_name in experiments:
            ...
            try:
                acc, prec, rec, f1, mcc, auc, cm = run_experiment(
                    train_dir, exp_name, seed, trial, pretrained_flag, output_dir, training_curves_data
                )
...
if __name__ == '__main__':
    ...
    print("\n" + "=" * 60)
    print("STEP 3: Running Major Experiment 1 (No Pretrained, No Freezing)")
    print("=" * 60)
    output_dir_1 = results_dir / f'{timestamp}_noptr_nofre'
    run_major_experiment(pretrained_flag=False, output_dir=output_dir_1)

    print("\n" + "=" * 60)
    print("STEP 4: Running Major Experiment 2 (Pretrained, No Freezing)")
    print("=" * 60)
    output_dir_2 = results_dir / f'{timestamp}_ptr_nofre'
    run_major_experiment(pretrained_flag=True, output_dir=output_dir_2)
