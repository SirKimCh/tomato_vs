...
experiments = [e for e in ORDERED if e in all_exps_in_csv] + \
              [e for e in all_exps_in_csv if e not in ORDERED]
exp_labels = {e: LABEL_MAP.get(e, e) for e in experiments}
colors     = {e: COLOR_MAP.get(e, '#95a5a6') for e in experiments}
...
plt.suptitle('Augmentation Method Comparison – EfficientNet-B0 (Few-Shot)\nMean ± Std',
